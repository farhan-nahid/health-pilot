...
class Review(models.Model):
    ...
    def __str__(self):
        ...
        doctor_name = self.doctor.user.last_name if self.doctor and self.doctor.user else "Unknown"
        patient_name = self.patient.user.get_full_name() if self.patient and self.patient.user else "Unknown"
