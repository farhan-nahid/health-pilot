...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-24 lg:px-8">
      <h1 className="mb-8 font-bold text-4xl">Terms and Conditions</h1>
      <div className="prose dark:prose-invert text-gray-600 dark:text-gray-400">
        <p>
          By accessing the website at Health Pilot, you are agreeing to be bound by these
        ...
        <p>
          ...
          (information or software) on Health Pilot's website for personal, non-commercial
        ...
        <p>
          The materials on Health Pilot's website are provided on an 'as is' basis. Health
          Pilot makes no warranties, expressed or implied, and hereby disclaims and
        ...
        <p>
          The information provided through this platform is for informational purposes
