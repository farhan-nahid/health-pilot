...
import { Activity, Mail, MapPin, Phone, Send } from "lucide-react";
      ...
      <nav className="flex items-center justify-between p-6 lg:px-8 border-b border-gray-100 dark:border-zinc-800">
        <div className="flex lg:flex-1 items-center gap-8">
          ...
          <div className="hidden lg:flex gap-x-8">
            ...
            <Link href="/contact" className="text-sm font-semibold leading-6 text-blue-600 dark:text-blue-400">Contact</Link>
          </div>
        </div>
